      ...
      <div className="max-w-6xl mx-auto">
        <article className="prose prose-lg prose-gray max-w-none">
          <header className="mb-12">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Video Emotion Analysis</h1>
            <p className="text-xl text-gray-600 mb-6">Upload a video to detect emotions frame by frame using AI analysis</p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-8">Upload & Analyze Video</h2>
