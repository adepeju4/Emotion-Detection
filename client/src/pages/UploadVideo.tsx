...
export default function UploadVideo() {
  ...
  const analyzeFrame = async (): Promise<EmotionResult | null> => {
        ...
        <article className="prose prose-lg prose-gray max-w-none">
          <header className="mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-4 sm:mb-6">
              Upload a video to detect emotions frame by frame using AI analysis
            </p>
          ...
          <section className="mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base text-gray-700 mb-6 sm:mb-8">
              Upload a video file to analyze emotions across multiple frames.
              The system will process the video frame by frame, detecting
              emotions and providing comprehensive analysis results with
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-amber-700">
                    <p>
                      This emotion detection system is for research and
                      educational purposes. Model accuracy varies by dataset and
                      conditions. For detailed performance metrics, limitations,
                      and methodology, please refer to our{" "}
                      <Link
                        to="/research"
                ...
                {currentResult && (
                  <div className="mt-8 p-4 bg-white border rounded-lg">
                    ...
                    <p className="text-xs text-gray-500 mt-4 text-center">
                      Processing time:{" "}
                      {currentResult.processing_time.toFixed(3)}s
                    </p>
                  </div>
                )}
              </div>
